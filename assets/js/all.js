...
document.addEventListener('alpine:init', () => {
   ...
   Alpine.data('hero', () => ({
      socials: [
         ...
         {
            ID: 4,
            link: 'https://drive.google.com/file/d/1E_t4OHYkE_rRXdunVp2IEIAhTmQjsz1a/view?usp=sharing',
      ...
      projects: [
         {
            ...
            description: 'Site responsivo em HTML, CSS, JS, Bootstrap, PHP e Wordpress.',
            link1: {
               name: 'Site',
         ...
         },
         {
            ...
            description: 'Site responsivo em HTML, CSS, JS, PHP, Wordpress e Bootstrap para um cliente.',
            link1: {
               name: 'Site',
         ...
         },
         {
            ...
            description: 'Site responsivo em HTML, CSS, JS, PHP e Wordpress para um cliente.',
            link1: {
               name: 'Site',
         ...
         },
         {
            ...
            title: 'Altabase',
            description: 'Site responsivo feito em HTML, CSS, TailwindCSS, JQuery, PHP e Wordpress.',
            link1: {
               name: 'Site',
         ...
         },
         {
            ...
            title: 'Portfolio 1.0',
            description: 'Site responsivo feito em HTML, CSS e Jquery. Primeira versão do meu portfolio.',
            link1: {
               name: 'Site',
         ...
         },
         {
            ...
            title: 'Highlighter',
            description: 'App mobile feito com Android Studio e Java para um projeto da faculdade.',
            link1: {
               name: 'Behance',
         ...
         },
         {
            ...
            title: 'Infomarket',
            description: 'Programa desktop feito em com Visual Studio, C# e .NET para um projeto da faculdade.',
            link1: {
               name: 'Behance',
         ...
         },
         {
            ...
            title: 'Book Finder',
            description: 'Um aplicativo desktop feito com Vite, Vue.js e TailwindCSS para um projeto pessoal.',
            link1: {
               name: 'Github',
